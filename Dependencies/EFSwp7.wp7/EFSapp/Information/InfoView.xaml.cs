...
namespace EFSresources.App.Information
{
	public partial class InfoView : PhoneApplicationPage
	{
		...
		{
            this.AppBarIconButtonSend = new ApplicationBarIconButton() { IconUri = new Uri("/EFSapp;component/Icons/appbar.mail.send.png", UriKind.RelativeOrAbsolute), Text = EFSlanguage.DicSendOff };
